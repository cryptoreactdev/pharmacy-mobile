...
import RoutineCard from "../components/homescreencards/routineCard";
                    ...
                    <ScrollView
                        ...
                        <View>
                            <View style={styles.header}>
                                ...
                                <Text style={styles.txtHeader}>Edit My Routine</Text>
                            </View>

                            <View style={{ paddingHorizontal: 18, marginTop: 12 }}>
                                <Text style={styles.txtSubHeading}>My Routine</Text>
                            </View>
                            ...
                            {dummyProductData.map((item, index) => (
                                <TouchableOpacity
                                    ...
                                    key={index}
                                    onPress={() => props.navigation.navigate("dailyroutine", { from: "EDIT_ROUTINE" })}
                                >
